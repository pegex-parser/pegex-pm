...
=item L<http://en.wikipedia.org/wiki/Operator-precedence_parserZ>
...
Climbing method. See:
L<http://en.wikipedia.org/wiki/Operator-precedence_parser#Precedence_climbing_method>.
...
a separate base class called C<examples/lib/Precedence.pm>.
...
L<https://github.com/ingydotnet/pegex-pm/blob/master/examples/lib/Precedence.pm>
...
Unlike C<calculator1.pl> where we evaluated as we parsed,
C<calculator2.pl> creates an RPN which is akin to an AST. In other
...
separate/reusable module: C<examples/lib/RPN.pm>. This is another 30
lines of Perl. Please take a look at it.
L<https://github.com/ingydotnet/pegex-pm/blob/master/examples/lib/RPN.pm>
